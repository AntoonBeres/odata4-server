...
import { createFilter } from 'odata4-mongodb';
...
export class MetaController extends ODataController {
  ...
  findOneByKeys(
    ...
    @odata.key('Id') key1: number,
    @odata.key('p10') key2: number,
    @odata.key('p9') key3: number,
    @odata.key('MongoId') key4: string,
  ) {
    let meta = new Meta();
    meta.Id = key1;
    meta.p9 = key3;
  ...
  getMediaRef(
    @odata.link('Id') link1: number,
    @odata.link('StringId') link2: number,
    @odata.key('MongoId') k1: string,
    @odata.key('p9') k2: number,
    @odata.key('p10') k3: number,
    @odata.key('Id') k4: number,
...
export class CompoundKeyController extends ODataController {
  ...
  @odata.method('GET')
  findOneByKeys(
    @odata.key('bc0') key1: number,
    @odata.key('bc1') key2: number,
    @odata.key('bc2') key3: boolean,
    @odata.key('bc3') key4: number,
    @odata.key('bc4') key5: string,
    @odata.key('bc5') key6: number,
  ) {
    let ck = new CompoundKey();
    ck.bc0 = key1;
    ck.bc1 = key2;
