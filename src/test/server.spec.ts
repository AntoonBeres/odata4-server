...
import products = require('./model/products');
...
export function testFactory(createTest: any) {
  describe('OData CRUD', () => {
    ...
    createTest(
      'should update entity using delta',
      TestServer,
      'PATCH /EntitySet(1)',
      {
        statusCode: 204,
    ...
    createTest(
      'should call action import with parameters',
      TestServer,
      'POST /ActionImportParams',
      {
        statusCode: 204,
      },
      {
    ...
    createTest(
      'should call function import with multiple parameters using parameter alias',
      TestServer,
      "GET /FunctionImportMore(value=@value,message=@message)?@value=42&@message='hello world'",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Edm.String',
    ...
    createTest(
      'should call function import with multiple parameters (different ordering)',
      TestServer,
      "GET /FunctionImportMore(message='hello world',value=42)",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Edm.String',
    ...
    createTest(
      'should call bound collection function using parameter alias',
      TestServer,
      'GET /BoundOperationEntitySet/Default.Function(value=@value)?@value=42',
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Edm.String',
    ...
    createTest(
      'should call function import with multiple parameters',
      TestServer,
      "GET /BoundOperationEntitySet/Default.FunctionMore(value=42,message='hello world')",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Edm.String',
    ...
    createTest(
      'should call function import with multiple parameters using parameter alias',
      TestServer,
      "GET /BoundOperationEntitySet/Default.FunctionMore(value=@value,message=@message)?@value=42&@message='hello world'",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Edm.String',
    ...
    createTest(
      'should call function import with multiple parameters (different ordering)',
      TestServer,
      "GET /BoundOperationEntitySet/Default.FunctionMore(message='hello world',value=42)",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Edm.String',
    ...
    createTest('should return entity collection navigation property result', TestServer, "GET /Categories('578f2baa12eaebabec4af290')/Products", {
      ...
      body: {
        ...
        value: products
          .filter((product) => product.CategoryId && product.CategoryId.toString() == '578f2baa12eaebabec4af290')
          .map((product) =>
            Object.assign(
              {
    ...
    createTest(
      'should return entity collection navigation property result with filter',
      TestServer,
      "GET /Categories('578f2baa12eaebabec4af290')/Products?$filter=Name eq 'Pavlova'",
      {
        statusCode: 200,
        body: {
          '@odata.context': "http://localhost/$metadata#Categories('578f2baa12eaebabec4af290')/Products",
          value: products
            .filter((product) => product.CategoryId && product.CategoryId.toString() == '578f2baa12eaebabec4af290' && product.Name == 'Pavlova')
            .map((product) =>
              Object.assign(
                {
    ...
    createTest(
      'should return entity collection navigation property result',
      TestServer,
      "GET /Categories('578f2baa12eaebabec4af289')/Products('578f2b8c12eaebabec4af23c')",
      {
        statusCode: 200,
        body: Object.assign(
          {
    ...
    createTest(
      'should return stream result stream of Products referenced to Category using generator function',
      TestServer,
      "GET /Categories2('578f2baa12eaebabec4af290')/Products2",
      {
        statusCode: 200,
        body: {
          '@odata.context': "http://localhost/$metadata#Categories2('578f2baa12eaebabec4af290')/Products2",
          value: products
            .filter((product) => product && product.CategoryId.toString() === '578f2baa12eaebabec4af290')
            .map((product) => {
              return Object.assign({ '@odata.id': `http://localhost/Products2('${product._id}')` }, product);
            }),
        },
    ...
    createTest(
      'should return product referenced to category using generator function',
      TestServer,
      "GET /Categories2('578f2baa12eaebabec4af289')/Products2('578f2b8c12eaebabec4af23c')",
      {
        statusCode: 200,
        body: {
    ...
    createTest(
      'should return stream result stream of Categories referenced to Product using generator function',
      TestServer,
      "GET /Products2('578f2b8c12eaebabec4af23c')/Category2",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Categories2/$entity',
    ...
    createTest(
      'should return promise of category referenced to product using generator function',
      TestServer,
      "GET /AdvancedProducts('578f2b8c12eaebabec4af23c')/CategoryPromise",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#AdvancedCategories/$entity',
    ...
    createTest(
      'should return promise of products referenced to category using generator function',
      TestServer,
      "GET /AdvancedCategories('578f2baa12eaebabec4af289')/ProductPromises",
      {
        statusCode: 200,
        body: {
          '@odata.context': "http://localhost/$metadata#AdvancedCategories('578f2baa12eaebabec4af289')/ProductPromises",
          value: products
            .filter((product) => product && product.CategoryId.toString() === '578f2baa12eaebabec4af289')
            .map((product) => {
              return Object.assign({ '@odata.id': `http://localhost/AdvancedProducts('${product._id}')` }, product);
            }),
        },
    ...
    createTest(
      'should return single product using generator function that calls another generator function',
      TestServer,
      "GET /GeneratorProducts('578f2b8c12eaebabec4af23c')",
      {
        statusCode: 200,
        body: {
    ...
    createTest(
      'should return single category using generator function that calls another generator function',
      TestServer,
      "GET /GeneratorCategories('578f2baa12eaebabec4af289')",
      {
        statusCode: 200,
        body: {
    ...
    createTest(
      'should return single category referenced to product using generator function that calls another generator function',
      TestServer,
    ...
    createTest(
      'should return products referenced to category using generator function that calls another generator function',
      TestServer,
      "GET /GeneratorCategories('578f2baa12eaebabec4af289')/GeneratorProducts",
      {
        statusCode: 200,
        body: {
    ...
    createTest(
      'should return product with only name and category property',
      TestServer,
      "GET /Products('578f2b8c12eaebabec4af23c')?$select=Name,CategoryId",
      {
        statusCode: 200,
        body: {
    ...
    createTest(
      'should return filtered product with only name and category property',
      TestServer,
      "GET /Products?$filter=_id eq '578f2b8c12eaebabec4af23c'&$select=Name,CategoryId",
      {
        statusCode: 200,
        body: {
    ...
    createTest(
      'should return Category entity with navigation property',
      TestServer,
      "GET /Categories('578f2baa12eaebabec4af289')/Products('578f2b8c12eaebabec4af23c')/Category",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Categories/$entity',
    ...
    createTest(
      'should return Category name with navigation property',
      TestServer,
      "GET /Categories('578f2baa12eaebabec4af289')/Products('578f2b8c12eaebabec4af23c')/Category/Name",
      {
        statusCode: 200,
        body: {
    ...
    describe('Expand tests', () => {
          ...
          value: products.map((product) => {
            return Object.assign({ '@odata.id': `http://localhost/Products('${product._id}')` }, product, {
              Category: Object.assign(
                { '@odata.id': `http://localhost/Categories('${product.CategoryId}')` },
      ...
      createTest('should return categories expanded with products', TestServer, 'GET /Categories?$expand=Products', {
        ...
        body: {
          ...
          value: categories.map((category) => {
            return Object.assign({ '@odata.id': `http://localhost/Categories('${category._id}')` }, category, {
              Products: products
                .filter((p) => p.CategoryId.toString() === `${category._id}`)
      ...
      createTest(
        'should return GeneratorProducts expanded with GeneratorCategory result using generator function',
        TestServer,
        'GET /GeneratorProducts?$expand=GeneratorCategory',
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#GeneratorProducts',
            value: products.map((product) => {
              return Object.assign({ '@odata.id': `http://localhost/GeneratorProducts('${product._id}')` }, product, {
                GeneratorCategory: Object.assign(
                  { '@odata.id': `http://localhost/GeneratorCategories('${product.CategoryId}')` },
                  categories.find((c) => c._id.toString() === product.CategoryId.toString()),
                ),
              });
            }),
      ...
      createTest(
        'should return GeneratorCategories expanded with GeneratorProducts using generator function',
        TestServer,
        'GET /GeneratorCategories?$expand=GeneratorProducts',
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#GeneratorCategories',
      ...
      createTest(
        'should return GeneratorProduct expanded with GeneratorCategories using generator function and navigation property',
        TestServer,
        "GET /GeneratorProducts('578f2b8c12eaebabec4af23c')?$expand=GeneratorCategory",
        {
          statusCode: 200,
          body: Object.assign(
            {
      ...
      createTest(
        'should return GeneratorCategory expanded with GeneratorProducts using generator function and navigation property',
        TestServer,
        "GET /GeneratorCategories('578f2baa12eaebabec4af289')?$expand=GeneratorProducts",
        {
          statusCode: 200,
          body: Object.assign(
            {
      ...
      createTest(
        'should return stream result of Products2 expanded with Category2 using generator function',
        TestServer,
        'GET /Products2?$expand=Category2',
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#Products2',
            value: products.map((product) => {
              return Object.assign({ '@odata.id': `http://localhost/Products2('${product._id}')` }, product, {
                Category2: {
                  value: categories
                    .filter((c) => c._id.toString() === product.CategoryId.toString())
      ...
      createTest(
        'should return stream result of Products2 expanded with Category2 using generator function and navigation property',
        TestServer,
        "GET /Products2('578f2b8c12eaebabec4af23c')?$expand=Category2",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#Products2/$entity',
      ...
      createTest(
        'should return stream result of Category2 and expanded with Products2 using generator function and navigation property',
        TestServer,
        "GET /Categories2('578f2baa12eaebabec4af289')?$expand=Products2",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#Categories2/$entity',
      ...
      createTest(
        'should return Category filtered by Name and expanded with Products',
        TestServer,
        "GET /Categories?$expand=Products&$filter=Name eq 'Beverages'",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#Categories',
      ...
      createTest(
        'should return Category2 filtered by Name and expanded with Products2 using generator function',
        TestServer,
        "GET /Categories2?$expand=Products2&$filter=Name eq 'Beverages'",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#Categories2',
      ...
      createTest(
        'should return Products2 filtered by Name and expanded with Category2 using generator function',
        TestServer,
        "GET /Products2?$expand=Category2&$filter=contains(Name,'Ch')",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#Products2',
      ...
      createTest(
        'should return Category filtered by Name and expanded with Product filtered by name',
        TestServer,
        "GET /Categories?$expand=Products($filter=Name eq 'Chai')&$filter=Name eq 'Beverages'",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#Categories',
      ...
      createTest(
        'should return Category2 filtered by Name and expanded with Product2 which filtered by name using generator function that returns stream result',
        TestServer,
        "GET /Categories2?$expand=Products2($filter=Name eq 'Chai')&$filter=Name eq 'Beverages'",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#Categories2',
      ...
      createTest(
        'should return GeneratorCategory filtered by Name and expanded with GeneratorProduct which filtered by name using generator function that returns generator function',
        TestServer,
        "GET /GeneratorCategories?$expand=GeneratorProducts($filter=Name eq 'Chai')&$filter=Name eq 'Beverages'",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#GeneratorCategories',
      ...
      createTest(
        'should return GeneratorCategory filtered by Name and expanded with GeneratorProduct which filtered by name using generator function that returns generator function',
        TestServer,
        "GET /GeneratorCategories?$expand=GeneratorProducts($filter=Name eq 'Chai')",
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#GeneratorCategories',
      ...
      createTest(
        'should return GeneratorCategories expanded with GeneratorProduct using $top,$filter,$expand subqueries',
        TestServer,
        'GET /GeneratorCategories?$expand=GeneratorProducts($top=1)&$top=1&$orderby=Name desc',
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#GeneratorCategories',
      ...
      createTest(
        'should return GeneratorCategories expanded with GeneratorProduct using $top,$filter,$expand subqueries',
        TestServer,
        'GET /GeneratorCategories?$expand=GeneratorProducts($orderby=Name desc)&$top=1&$orderby=Name desc',
        {
          statusCode: 200,
          body: {
            '@odata.context': 'http://localhost/$metadata#GeneratorCategories',
    ...
    createTest('should return result including complex type', AuthenticationServer, 'GET /Users', {
      ...
      body: {
        ...
        value: [
          Object.assign(new User(1, new Location('Budapest', 'Virág utca')), {
  ...
  describe('Navigation property', () => {
    createTest(
      'should return navigation property result',
      MetaTestServer,
      "GET /Meta(MongoId='578f2b8c12eaebabec4af242',Id=1,p9=9,p10=10)/Meta.Meta/MediaList",
      {
        statusCode: 200,
        body: {
    ...
    createTest(
      'should return navigation property result by key',
      MetaTestServer,
      "GET /Meta(MongoId='578f2b8c12eaebabec4af242',Id=1,p9=9,p10=10)/Meta.Meta/MediaList(Id=1,StringId='two')",
      {
        statusCode: 200,
        body: {
    ...
    createTest(
      'should return navigation property result by key',
      MetaTestServer,
      "GET /Meta(MongoId='578f2b8c12eaebabec4af242',Id=1,p9=9,p10=10)/Meta.Meta/MediaList(Id=3,StringId='asd')/$ref",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#$ref',
    ...
    createTest(
      'should create product with navigation property',
      TestServer,
      "POST /Categories('578f2baa12eaebabec4af290')/Products",
      {
        statusCode: 201,
        body: {
  ...
  describe('Expand', () => {
    createTest(
      'should return expanded Meta result with media',
      MetaTestServer,
      "GET /Meta(MongoId='578f2b8c12eaebabec4af242',Id=1,p9=9,p10=10)?$expand=Meta.Meta/MediaList",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Meta/$entity',
    ...
    createTest(
      'should return expanded Meta result with the filtered media',
      MetaTestServer,
      "GET /Meta(MongoId='578f2b8c12eaebabec4af242',Id=1,p9=9,p10=10)?$expand=Meta.Meta/MediaList($filter=Id eq 1)",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Meta/$entity',
    ...
    createTest(
      'should return expanded Meta result with the filtered media',
      MetaTestServer,
      "GET /Meta(MongoId='578f2b8c12eaebabec4af242',Id=1,p9=9,p10=10)?$expand=Meta.Meta/MediaList($top=1)",
      {
        statusCode: 200,
        body: {
          '@odata.context': 'http://localhost/$metadata#Meta/$entity',
    ...
    describe('use odata type in action/function', () => {
      ...
      createTest(
        'call action what use odata type',
        MetaTestServer,
        'POST /EmptyEntity/Server.emptyEntityAction',
        {
          statusCode: 204,
        },
  ...
  describe('Test entity', () => {
    ...
    createTest(
      'should create a test entity with base controller insert method',
      MetaTestServer,
      'POST /TestEntity',
      {
        statusCode: 201,
